                                  ...
                                  for ($k=1; $k<=$number ; $k++) { 
                                   ...
                                   ?>
                                            <tr style="text-align: center;">
                                                ...
                                                <a href="../../uploads/<?php echo $rs['payment'];?>" target="_blank"><p>View Slip</p></a>
                                                </div>  
                                                </td>
                                                <td>
                                                    <button class="btn btn-primary" name="clicked"><a style="color: #fff; text-decoration: none;" href="pay.php?id=<?php echo $rs['id'];?>">Received?</a></button>
                                                    <button class="btn btn-danger"><a style="color: #fff; text-decoration: none;" href="pending.php?id=<?php echo $rs['id'];?>">Pending!</a></button></td>
                                                </td>
                                                 <td>
