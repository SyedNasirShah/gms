...
include "header.php";
  ...
  <main id="main">
    ...
    <div class="breadcrumbs projects" data-aos="fade-in">
      <div class="container">
        <h2 style="color: #fff;">Classes</h2>
        <p>You don’t come to get strong. You come to get stronger.</p>
      </div>
    </div><!-- End Breadcrumbs -->
...
Please Attach Receipt of Payment while submitting the form.</h5><br>
  ...
  <div class="row">
   ...
   <div class="col-md-8">
   <h1 style="margin-top: 20px;">Apply Now for Class</h1>
              <form action="add-class-data.php" method="POST" enctype="multipart/form-data">
